...
BOOST_AUTO_TEST_CASE(test_rb_tree_remove_leaf_one_child_two_children)
{
  TestTree tree; for (int i = 1; i <= 9; ++i) { tree.push(i, std::to_string(i)); }
  BOOST_TEST(tree.drop(9) == "9"); BOOST_TEST(tree.drop(8) == "8");
